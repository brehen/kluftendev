...
const moveMe = direction => {
  var aboutMeOffset =
    ...
    window.scrollY
  if (direction === 'down') animateScrollTo(aboutMeOffset - 200)
            ...
            <div className='flex flex-col ju__stify-center items-center'>
              <div className='w-10/12 md:w-7/12 flex justify-center flex-col items-center'>
                ...
                <h3 className='text-xl my-8 text-gray'>
                  ...
                  <span> <img className='inline h-4 m-0 align-baseline' src='https://www.itverket.no/wp-content/themes/itverket/assets/images/logo.png' alt='Logo of current employer, ITVerket' /> </span> creating cool
...
const HeroSection = () => {
  ...
  return (
    <header className='pb-16 bg-branddark sm:pb-0'>
